...
class ScrapingIGTIlogSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        for article in articles:
            ...
            if len(categories) == 1:
                ...
                while i < len(categories):
                    ...
                    #              catUrl.append(''.join(categories.xpath('@href').extract()))
                    i += 1
                                                
        title = article.xpath(".//h2[@class='entry-title h3']//a")
            
        item['titulo_pagina'] = ''.join(title.xpath('text()').get())
        ...
        comentario = metadata.xpath(".//div[@class = 'meta-item meta-comment']//a//span[@class='dsq-postid']")
